...
/* $Id: //dvt/mti/rel/6.5b/src/tkgui/wlf_api.h#1 $ */
...
typedef long WlfTime64;
#define WLF_TIME64_INIT(h,l)    ((long)(h)<<32 | (unsigned int)(l))
#define WLF_TIME64_HI32(t)      ((int)((t)>>32))
#define WLF_TIME64_LO32(t)      ((unsigned int)(t))
#define WLF_TIME64_ASGN(t,h,l)  {(t) = (long)(h)<<32 | (unsigned int)(l);}
...
#define wlfSelTrStream			0x0000400000000000LL
#define wlfSelTrStreamArray		0x0000800000000000LL

#define wlfSelScExport			0x0001000000000000LL
#define wlfSelVlPackage			0x0002000000000000LL
#define wlfSelVlProgram         0x0004000000000000LL
#define wlfSelVlTypedef         0x0008000000000000LL

#define wlfSelSVParamClass		0x0010000000000000LL
#define wlfSelCellInternal      0x0020000000000000LL
#define wlfSelClockingBlock     0x0040000000000000LL
#define wlfSelTaThreadMon       0x0200000000000000LL
#define wlfSelImmediateAssert   0x2000000000000000LL
...
#define wlfSelTrStream			0x0000400000000000
#define wlfSelTrStreamArray		0x0000800000000000

#define wlfSelScExport			0x0001000000000000
#define wlfSelVlPackage			0x0002000000000000
#define wlfSelVlProgram         0x0004000000000000
#define wlfSelVlTypedef         0x0008000000000000

#define wlfSelSVParamClass		0x0010000000000000
#define wlfSelCellInternal      0x0020000000000000
#define wlfSelClockingBlock     0x0040000000000000
#define wlfSelTaThreadMon       0x0200000000000000
#define wlfSelImmediateAssert   0x2000000000000000
#endif
...
#define wlfSelHdlScopes         ( wlfSelVhdlScopes | wlfSelVlogScopes )
...
extern int           wlfFileEndTime    (WlfFileId fp, WlfTime64 *time);
...
//  Time Functions
******************************************************************************/
extern int  wlfPackTime( WlfPackId packId, WlfTime64 *time );
extern int  wlfPackDelta( WlfPackId packId, int *delta );
extern int  wlfPackEndTime( WlfPackId packId, WlfTime64 *time );
...
extern char *wlfTime64ToString( char* buf,  WlfTime64  time);
...
extern int          wlfWrtFileClose( WlfWrtFileId fp, WlfTime64 time );
...
extern int wlfWrtTimeAdvance( WlfWrtFileId fp, WlfTime64 time, unsigned int iteration );
...
extern int wlfWrtArraySetValue( WlfSymbolId symbol, WlfWrtLogMode flag, int index, int val );
