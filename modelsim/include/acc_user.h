...
/* $Id: //dvt/mti/rel/6.5b/src/vsim/acc_user.h#1 $ */
...
XXTERN handle     *acc_collect PROTO_PARAMS((handle (*p_next_routine)(), handle scope_object, PLI_INT32 *aof_count));
...
XXTERN PLI_INT32   acc_count PROTO_PARAMS((handle (*next_func)(), handle object_handle));
