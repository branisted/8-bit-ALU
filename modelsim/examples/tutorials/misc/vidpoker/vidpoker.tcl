...
proc autoEval {} {
    ...
    set ranks [lappend ranks [xlateRank [examine /top/rank0]]]
    set ranks [lappend ranks [xlateRank [examine /top/rank1]]]
    set ranks [lappend ranks [xlateRank [examine /top/rank2]]]
    set ranks [lappend ranks [xlateRank [examine /top/rank3]]]
    set ranks [lappend ranks [xlateRank [examine /top/rank4]]]

    set suits [lappend suits [xlateSuit [examine /top/suit0]]]
    set suits [lappend suits [xlateSuit [examine /top/suit1]]]
    set suits [lappend suits [xlateSuit [examine /top/suit2]]]
    set suits [lappend suits [xlateSuit [examine /top/suit3]]]
    set suits [lappend suits [xlateSuit [examine /top/suit4]]]
...
proc getCard c {
    ...
    switch $c {
        0 {set r [examine /top/rank0]; set s [examine /top/suit0]}
        1 {set r [examine /top/rank1]; set s [examine /top/suit1]}
        2 {set r [examine /top/rank2]; set s [examine /top/suit2]}
        3 {set r [examine /top/rank3]; set s [examine /top/suit3]}
        4 {set r [examine /top/rank4]; set s [examine /top/suit4]}
