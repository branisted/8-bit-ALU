...
catch {exec cl -c -I$env(MTI_HOME)/include pli_test.c} msg
echo $msg
exec link -dll -export:veriusertfs pli_test.obj $env(MTI_HOME)/win32/mtipli.lib

exec rm -rf work
vlib work
vlog prim.v dff.v top.v

vsim -do "run -all" top -pli pli_test.dll
