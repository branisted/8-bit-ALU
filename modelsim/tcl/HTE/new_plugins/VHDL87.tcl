#HTEParser#vhdl'87#LexVHDL87#VHDL Files#VHDL '87 Plugin#vhdl|vhd#
# =============================================================================
#
...
#   HTE::registerInitScript [namespace current]::init
   ...
   set statementBeginningRE {\m(alias|assert|attribute|constant|disconnect|exit|file|generic|group|library|next|signal|subtype|type|use|variable|wait|with)\M}
    variable matchingObject {
       ...
       {\mend\s+(\w+)\M}                        {}                   {backward}
       {\mend\M\s+|\mend\s+(entity|architecture|configuration|for|package|procedure|function|component|units|record|block|process\s+process|generate|if|case|loop)\M}                              {\m(entity|architecture|configuration|package|procedure|function|component|units|record|block|process|generate|if|case|loop)\M}              {backward}
...
#      lappend PluginTagsList operation "preproc {-foreground navy} {}"
...
#CB_PER   if { $failed } {
#CB_PER      putLog \"[namespace tail [namespace current]]::structuralParserCB: ERROR: unknown block type \"$type\" was encountered at line $start"
#CB_PER   }
